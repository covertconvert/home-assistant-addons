...
def _session_deep_link(session_id: str) -> str:
    """URL the mobile_app should open on notification tap. Best-effort: the
    ingress panel URL is auto-generated by Supervisor but this slug+query
    combination is what the addon registers in Sidebar."""
    return f"/hassio/ingress/claude_code_messages?session={session_id}"
