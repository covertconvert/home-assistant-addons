...
- **"Build me a dashboard for my solar inverter"** → Paste a screenshot of the data you want, Claude generates the YAML, you commit it via the file editor addon
...
- **Resume** — pick a session back up after the addon restarts
